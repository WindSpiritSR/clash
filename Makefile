...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/WindSpiritSR/clash/constant.Version=$(VERSION)" \
		-X "github.com/WindSpiritSR/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
